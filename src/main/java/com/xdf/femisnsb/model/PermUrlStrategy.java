...
public class PermUrlStrategy {
	...
	public String toString() {
		return "PermUrlStrategy [url=" + url + ", aclmoduleid=" + aclmoduleid + ", shirointerceptor=" + shirointerceptor
				+ ", createtime=" + createtime + ", roleid=" + roleid + ", permid=" + permid + ", remark=" + remark
				+ "]";
	}
