...
public class OrderDetail {
	...
	public String toString() {
		return "OrderDetail [id=" + id + ", mainid=" + mainid + ", ordercode=" + ordercode + ", oordercode="
				+ oordercode + ", stylecode=" + stylecode + ", goodsname=" + goodsname + ", spec01=" + spec01
				+ ", spec02=" + spec02 + ", size=" + size + ", colorcode=" + colorcode + ", colorname=" + colorname
				+ ", color=" + color + ", meter=" + meter + ", kg=" + kg + ", yard=" + yard + ", chargeunit="
				+ chargeunit + ", price=" + price + ", amount=" + amount + ", platemake=" + platemake + ", sample="
				+ sample + ", remark=" + remark + ", createtime=" + createtime + ", creator=" + creator
				+ ", updatetime=" + updatetime + ", updater=" + updater + ", status=" + status + "]";
	}
