...
public class StringUtil {  
    ...
    /** 
     * 功能：过滤掉所有非数字字符，返回剩余数字构成的字符串。<br/> 
     *  
     * @author chanchaw
     * @date 2019年8月1日 21:54:14 
     * @param chkStr 
     *            被检查的字符串 
     * @return String 
     */  
    public static String getNumberString(String chkStr) {  
    	String rtn = "";
    ...
    public static void main(String[] args) {
		Integer ic = 3;
		System.out.println(getNumberString("for19073A0001"));
	}
